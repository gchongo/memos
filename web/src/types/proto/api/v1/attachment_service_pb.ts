...
export type Attachment = Message<"memos.api.v1.Attachment"> & {
  ...
  /**
   * Optional. Input-only JPEG thumbnail (e.g. first video frame). Stored in the instance thumbnail cache.
   *
   * @generated from field: bytes thumbnail = 10;
   */

...
function ShortcutsSection({ embedded = false }: { embedded?: boolean }) {
  ...
  return (
    <div className={cn("flex h-auto w-full shrink-0 flex-col flex-nowrap items-start justify-start", embedded ? "" : "mt-3 px-1")}>
      {!embedded && (

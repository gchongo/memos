          ...
          <div className="flex items-center justify-between gap-3 mb-1">
            <div className="flex items-center gap-1.5 flex-wrap min-w-0">
              ...
              <span className="text-sm text-muted-foreground/80">
                {isCommentMention ? t("inbox.mentioned-you-in-comment") : t("inbox.mentioned-you-in-memo")}
              </span>
          ...
          {mentionPayload.relatedMemo && (
            <div className="pl-3 border-l-2 border-muted-foreground/20 mb-3">
              <p className="text-sm text-foreground/60 line-clamp-1 leading-relaxed">
                ...
                {mentionPayload.relatedMemoSnippet || <span className="italic text-muted-foreground/40">{t("inbox.empty-memo")}</span>}
              </p>
            </div>
          )}
            ...
            <div className="flex items-start gap-2">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-xs text-primary/60 font-semibold mb-1 uppercase tracking-wider">
                  {isCommentMention ? t("inbox.comment-label") : t("inbox.memo-label")}
                </p>
                <p className="text-sm text-foreground/90 line-clamp-2">
                  {mentionPayload.memoSnippet || <span className="italic text-muted-foreground/50">{t("inbox.empty-memo")}</span>}
                </p>
              </div>
            </div>
          </div>
